...
const router = Router();
import { create_reservation, get_all_reservations, get_reservation_by_customer, get_reservation_by_id, get_reservation_by_professional, update_reservation } from "../controllers/reservationController.js";
...
router.get("/pro/:id", isAutenticated, idRules, validate, get_reservation_by_professional);
